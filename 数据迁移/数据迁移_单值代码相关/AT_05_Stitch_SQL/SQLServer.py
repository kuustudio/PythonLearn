...
# SQLResultClass = SQLExecResult.SqlExecuteServer
...
class GetSql(object):
    ...
    def deal_finally_sql(self):
        ...
        if "T_QSDF_" and "T_QT_" in self.source_count_sql:
            self.source_count_sql.replace("SASJ", "DJSJ")
        # 不能用长度判断 可能存在 NULL
        ...
        self.target_count_sql = self.get_finally_sql(sql_target_list)

    @staticmethod
    def get_finally_sql(sql_source_list):
        if sql_source_list:
            first = sql_source_list[SystemConstant.Zero] + sql_constant.flags + \
                    sql_constant.CommonConditions + sql_source_list[SystemConstant.One] + sql_constant.flags + \
                    sql_constant.AND
...
if __name__ == '__main__':
    d =  [[{'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '1', 'c_source_jtmz': '1', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '2', 'c_source_jtmz': '2', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '3', 'c_source_jtmz': '3', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '4', 'c_source_jtmz': '4', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '255', 'c_source_jtmz': '255', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '999001', 'c_source_jtmz': None, 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}], [{'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '1', 'c_source_jtmz': '1', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '2', 'c_source_jtmz': '2', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '3', 'c_source_jtmz': '3', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '4', 'c_source_jtmz': '4', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '255', 'c_source_jtmz': '255', 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}, {'c_target_ywlx': 'all', 'c_source_ywlx': 'all', 'c_target_zdm': 'C_JAFS', 'c_source_zdm': 'N_JAFSFB', 'c_target_dzdm': '11400335', 'c_source_dzdm': '10116007', 'c_target_jtmz': '999001', 'c_source_jtmz': None, 'c_sheet_mc': '刑事其它结案信息-xsaj', 'c_ms': 'xsaj', 'c_target_bm': 'T_XS_AJ_JA', 'c_target_sjlx': 'varchar', 'c_source_bm': 'T_QT_AJ', 'c_system_type': 'np', 'c_group': 'xsaj', 'lx': 'Single'}]]
